...
(/** @lends <global> */function($, window, document, undefined) {
	...
	// Global variable created to make search function get applied on every row
	...
	var DataTable = function( oInit )
	{
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( iPushFeature == 1 && nTmp !== null )
				{
						...
						if(nTmp.id == "intaliotable_filter")
						{
								
								$("#intaliotable").append( nTmp );
						}
						else if(nTmp.id == "instancestable_filter")
						{
							
							$("#instancestable").append( nTmp );
						}
						else if(nTmp.id == "instancestable_length")
						{
							
							$("#instancestable").append( nTmp );
						}
						else if(nTmp.id == "eventstable_filter")
						{
								
								$("#eventstable").append( nTmp );
						}
						else{
		...
		///*** Adding a function which returns the tds for a particular row
    ...
    return anTds;
		...
		function _fnLanguageCompat( oLanguage )
		{
			...
			if ( !oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
				oDefaults.sEmptyTable === "Processing..." )
			{
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			if(nLength.id == "instancestable_length")
			{
				nLength.className = "intancetable_length";
			}
			else
		...
		function _fnFeatureHtmlPaginate ( oSettings )
		{
			...
			DataTable.ext.oPagination[ oSettings.sPaginationType ].fnInit( oSettings, nPaginate, 
				function( oSettings ) {
					_fnCalculateEnd( oSettings );
					_fnDraw( oSettings );
					$("tbody > tr > td:first-child").css("text-align", "left");
				}
			);
