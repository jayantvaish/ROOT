(function (a) {
    a.fn.dashboard = function (m) {
        ...
        k.setLayout = function (n) {
            ...
            if (k.layout != null) {
                if (typeof b.layoutClass != "undefined") {
                    this.element.find("." + b.layoutClass).
                    addClass(k.layout.classname)
                } else {
        ...
        var d = a.extend({}, a.fn.dashboard.defaults.editLayoutSettings, m.
        editLayoutSettings);
        ...
        function h(n) {
            ...
            n.openContent = function () {
                ...
                if (!n.loaded) {
                    ...
                    k.log("
widgetShow event thrown for widget " + n.id, 2);
                    n.element.trigger("widgetShow", {
                        widget: n
                    })
                }
...
widgetClosed",
            ...
            n.serialize = function () {
                k.log("entering serialize function", 1);
                var q = '{"title" : "' + n.title + '", "id" : "' + n.id + '", "column" : "' + n.column + '","editurl" : "' + n.editurl + '","open" : ' + n.
                open + ',"url" : "' + n.url + '"';
                if (typeof n.metadata != "undefined") {
                    q += ',"metadata":{';
                    var s = n.metadata;
...
undefined") {
        ...
        a("#" + k.id + " .controls li").live("click", function (o) {
            ...
            var n = k.getWidget(a(this).closest("." + b.widgetClass).attr("id"));
            n.
            element.trigger("widgetCloseMenu", {
                widget: n
            });
        ...
        a("#" + k.id + " ." + b.
        widgetClass).live("widgetOpen", function (n, p) {
        ...
        a("#" + k.id + " ." + b.
        widgetHeaderClass).live("mouseover", function () {
        ...
        a("." + d.openDialogClass).live("click", function () {
            ...
            k.
            element.trigger("dashboardOpenLayoutDialog");
            return false
        });
                ...
                a.ajax({
                    ...
                    success: function (n) {
                        if (n == "NOK" || n.indexOf("<response>NOK</response>") != -1) {
                            ...
                            k.
                            element.trigger("dashboardSaveFailed")
                        } else {
        ...
        k.element.live("addWidgetDialogSelectCategory", function (o, n) {
            ...
            a.getJSON(url, {
                ...
                var p = q.result.data;
                if (typeof q.result.data.length == "
undefined") {
        ...
        k.element.live("
dashboardOpenWidgetDialog", function () {
