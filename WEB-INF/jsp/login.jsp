...
<c:set var="footer" >
	...
	<a href="http://www.intalio.com"><span style="color: #3082A8"><fmt:message key="com_intalio_bpms_console_pageFooter_poweredByValue" /></span></a>
	<fmt:message key="com_intalio_bpms_console_versionInfo">
		<c:choose>
	...
	<a href="http://bpms.intalio.com"><span style="color: #3082A8"><fmt:message key="com_intalio_bpms_console_pageFooter_featureBugRequest"/></span></a>
	</span>
</c:set>
...
<intalio:loginBody scripts="${scripts}" pageTitle="${pageTitle}" footer="${footer}">
	...
	<table>
				...
				<td style=" position:absolute; left:20px; top:30px; "><c:choose>
					...
					<c:otherwise>
						<label style="font-size: 12px;"> 
							<fmt:message key="com_intalio_bpms_console_login_username" /> </label>
					</c:otherwise>
				</c:choose></td>
		...
		<tr>
			...
			</c:choose> <fmt:message key="com_intalio_bpms_console_auto_login" /></td>
		</tr>
		<tr>
