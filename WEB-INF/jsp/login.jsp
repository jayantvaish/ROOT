<%-- Copyright (c) 2005-2008 Intalio inc. All rights reserved. This program
and the accompanying materials are made available under the terms of the
Eclipse Public License v1.0 which accompanies this distribution, and is
available at http://www.eclipse.org/legal/epl-v10.html Contributors: Intalio
                                    ...
                                    <head>
                                        ...
                                        <script type="text/javascript">
                                            $(document).ready(function () {
                                                ...
                                                $('#btnSubmit').bind("keydown", function (e) {
                                                    if (e.which == 13) {
                                    ...
                                    <body>
                                        ...
                                        <div id="wrapper">
                                            ...
                                            <form id="form" class="login-form" method="POST" onSubmit="document.getElementById('actionName').value = 'logIn';">
                                                ...
                                                <!--HEADER-->
                                                <div class="header">
                                                    <img src="${logoPath}" alt="Intalio Inc" style="padding-left:10%" />
                                                </div>
                                                <!--END HEADER-->
                                                <!--CONTENT-->
                                                <div class="content">
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${status.error}">
                                                                            <label style="font-size: 12px;">
                                                                                <fmt:message key="com_intalio_bpms_console_login_username" />
                                                                            </label>
                                                                        </c:when>
                                                                    </c:choose>
                                                                </td>
                                                                <td>
                                                                    <input type="text" size=16 name="username" onfocus="this.value=''" value="${login.username}"
                                                                    class="input username" />	<font color="red">${status.errorMessage}</font>
                                                                </td>
                                                            </spring:bind>
                                                        </tr>
                                                        <tr>
                                                            <spring:bind path="login.password">
                                                                <td style=" position:absolute; left:230px; top:30px;">
                                                                    <c:choose>
                                                                        <c:when test="${status.error}">
                                                                            <label style="font-size: 12px;">
                                                                                <fmt:message key="com_intalio_bpms_console_login_password" />
                                                                            </label>
                                                                        </c:when>
                                                                    </c:choose>
                                                                </td>
                                                                <td class="io-login-loginBox-password">
                                                                    <input type="password" name="password" onfocus="this.value=''" value="${login.password}"
                                                                    class="input password" />	<font color="red">${status.errorMessage}</font>
                                                                </td>
                                                            </spring:bind>
                                                        </tr>
                                                        <td>&nbsp;</td>
                                                            ...
                                                            <td>
                                                                <spring:bind path="login">
                                                                    <c:forEach items="${status.errorMessages}" var="errorMessage">
                                                                        <tr>
                                                                            <td colspan="3"><font color="red"> ${errorMessage} </font>
                                                                            </td>
                                                                        </tr>
                                                                    </c:forEach>
                                                                </spring:bind>
                                                ...
                                                <div class="footer">
                                                    <table>
                                                        <td class="io-login-loginBox-autoLoginchk" style="left:20px; top:95px;">
                                                            ...
                                                            <fmt:message key="com_intalio_bpms_console_auto_login" />
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <input type="submit" name="submit" id="btnSubmit" value="Login" class="button"
